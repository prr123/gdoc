...
func (dObj *gdocTxtDbgObj) initGdocTxt(folderPath string, options *gdocUtil.OptObj) (err error) {
	...
	doc := dObj.doc
	if dObj == nil {return fmt.Errorf("dObj is nil in gdocTxtDbgObj!")}
...
func (dObj *gdocTxtDbgObj) dispTOC(toc *docs.TableOfContents)(outstr string, err error) {
...
func (dObj *gdocTxtDbgObj) dispTable(tbl *docs.Table)(outstr string, err error) {
...
func (dObj *gdocTxtDbgObj) dispListProp(listp *docs.ListProperties)(outstr string, err error) {
...
func (dObj *gdocTxtDbgObj) dispPar(par *docs.Paragraph)(outstr string, err error) {
...
func (dObj *gdocTxtDbgObj) dispParEl(parDet *docs.ParagraphElement)(outstr string, err error) {
...
func (dObj *gdocTxtDbgObj) dispSecStyle(secStyl *docs.SectionStyle)(outstr string, err error) {
...
func (dObj *gdocTxtDbgObj) dispBorder(parBorder *docs.ParagraphBorder, wsp int)(outstr string) {
	...
	if parBorder.Color != nil {
		if parBorder.Color.Color != nil {
			colStr := gdocUtil.GetColor(parBorder.Color.Color)
...
func (dObj *gdocTxtDbgObj) getColor(color  *docs.Color)(outstr string) {
	outstr = ""
	if color != nil {
...
func (dObj *gdocTxtDbgObj) dispParStyl(parStyl *docs.ParagraphStyle, wsp int)(outstr string, err error) {
...
func (dObj *gdocTxtDbgObj) dispTxtStyl(txtStyl *docs.TextStyle, wsp int)(outstr string, err error) {
    ...
    if txtStyl.ForegroundColor != nil {
        if txtStyl.ForegroundColor.Color != nil {
            ...
            outstr += gdocUtil.GetColor(txtStyl.ForegroundColor.Color)
            outstr += "\n"
        }
    }
    if txtStyl.BackgroundColor != nil {
        if txtStyl.BackgroundColor.Color != nil {
            ...
            outstr += gdocUtil.GetColor(txtStyl.BackgroundColor.Color)
            outstr += "\n"
        }
    }
    if txtStyl.Link != nil {
...
func (dObj *gdocTxtDbgObj) dispBodySummary()(outstr string, err error) {
//    var listItem docList
...
func (dObj *gdocTxtDbgObj) dispContentEl(elStr *docs.StructuralElement)(outstr string, err error) {
...
func (dObj *gdocTxtDbgObj) dispContentElShort(elStr *docs.StructuralElement)(outstr string, err error) {
...
func CvtGdocToDbgTxt(folderPath string, doc *docs.Document, options *gdocUtil.OptObj)(err error) {
	var outstr string

	if doc == nil { return fmt.Errorf("error -- doc is nil!")}

    docObj := new(gdocTxtDbgObj)
    docObj.doc = doc
	docObj.DocOpt = true
